    ...
    <div class="row gy-4 mt-2">
        <div class="col-lg-4 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white">{{ $widget['total_plans'] }}</h3>
                    <p class="text-white">@lang('Total Plan')</p>
                </div>
                <a class="widget-two__btn" href="{{ route('admin.plan.index') }}">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-lg-4 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                <i class="las la-users overlay-icon text--white"></i>
                <div class="widget-two__icon b-radius--5 bg--primary">
                    <i class="la la-funnel-dollar"></i>
                </div>
                <div class="widget-two__content">
                    <h3 class="text-white">{{ $widget['running_investments'] }}</h3>
                    <p class="text-white">@lang('Running Investments')</p>
                </div>
                <a class="widget-two__btn" href="{{ route('admin.report.investments') }}/?status={{ Status::RUNNING }}">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white">{{ $widget['completed_investments'] }}</h3>
                    <p class="text-white">@lang('Complated Investments')</p>
                </div>

                <a class="widget-two__btn" href="{{ route('admin.report.investments') }}/?status={{ Status::COMPLETED }}">@lang('View All')</a>
            </div>
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
