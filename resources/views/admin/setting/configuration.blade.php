            ...
            <form action="" method="post">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Switch language')</p>
                                <p class="mb-0">
                                    <small>@lang('When language module will be disabled, default language is set for translate.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                    ...
                                    data-on="@lang('Enable')" data-off="@lang('Disable')" name="lang"
                                    @if ($general->lang) checked @endif>
                            </div>
                        </li>
